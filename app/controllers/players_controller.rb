class PlayersController < ApplicationController
  ...
  def set_initiative!
    ...
    @campaign.players.includes( :user ).order( 'initiative_bet DESC' ).each do |player|
      @campaign.add_log( @player, :initiative, :bet, count: player.initiative_bet )
      tmp_players << player
    end
    ...
    @campaign.add_log( new_first_player,:initiative, :order, count: new_first_player.initiative )
    ...
    @campaign.add_log( new_second_player,:initiative, :order, count: new_second_player.initiative )
