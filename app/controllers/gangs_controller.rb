  ...
  def create
    ...
    Gang.transaction do
      respond_to do |format|
        if @gang.save
          @campaign.add_log( @player,:gangs, :created, player_name: @player.user.name, gang_name: @gang.name )
  ...
  def destroy
    Gang.transaction do
      ...
      respond_to do |format|
        ...
        @campaign.add_log( @player,:gangs, :destroyed, player_name: @player.user.name, gang_name: @gang.name )
