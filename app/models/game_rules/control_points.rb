  ...
  class ControlPoints
    ...
    def gain_pp_for_control_points!
      @campaign.players.each do |player|
        ...
        player.pp += total_pp
        @campaign.add_log( player, :pp, :control_points_gain, name: player.user.name, count: total_pp )
    ...
    def loose_pp_for_mainteance!
      @campaign.players.each do |player|
        ...
        @campaign.add_log( player, :pp, :maintenance_loss, name: player.user.name, count: maintenance )
