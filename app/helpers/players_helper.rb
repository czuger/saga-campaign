module PlayersHelper
  ...
  # If the gang is at the base and has less than 4 points it can't move.
  def gang_cant_move?( gang )
    GameRules::Factions.recruitment_positions( @player ).include?( gang.location ) && gang.points < 4
  end
end
